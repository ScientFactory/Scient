...
| Scient desktop (Synara-derived) | `../scient-desktop/`; preserved primary sibling currently on local `agent/fix-file-link-worktree-resolution-20260726` at `8b8b7cc2bc87e973b9ca9919fa6285a028c19204`, not used as current-state evidence | `https://github.com/Emanuele-web04/synara.git`, `main` | `https://github.com/ScientFactory/scient-desktop`, public standalone repository | `9be46c3ce6a7521b64436b7334bc6fce16e3cac4` | Inspected owned `origin/main` `3829e5dd82a4760184aabafa4c96127744ef79f2`; the accepted repo-local checkpoint is `ab33931da4c8da884b1445244085f4eeee3eafb6`, while the new complete review evidence in [`2026-08-02-scient-desktop.md`](upstream-reviews/2026-08-02-scient-desktop.md) covers four further commits through `65f6684aa6ff88c8d57a9f11d541a54b41be1539` with zero remaining | Accepted initial application foundation; `divergent-cherry-pick`; must not own scientific project truth. |
| T3 Code | No canonical local checkout is retained. Disposable fetch-only bare inspection repositories are used and retain no canonical authority. | `https://github.com/pingdotgg/t3code.git`, `main` | None | Not tested in Gate 1.5 | Durable targeted-review boundary remains `bf76535fe4da71d8de7b8bd5ffa0d2086b7af8d0`; complete scheduled evidence now covers through `5192f777fe54c2a2a359f6c25ecf5fbde46d49b0`, including the five-commit range `ca72e381..5192f777` recorded in [`2026-08-02-t3-code.md`](upstream-reviews/2026-08-02-t3-code.md); stable release remains `v0.0.31`, and nightly `v0.0.32-nightly.20260801.976` points at the current observed tip | Daily research donor for desktop/runtime/provider/process/UI lessons; not an owned upstream or integration base. |
...
|---|---|---|---|---|---|
| Scient desktop | `3829e5dd82a4760184aabafa4c96127744ef79f2` | `ab33931da4c8da884b1445244085f4eeee3eafb6` on 2026-08-01 | `9be46c3ce6a7521b64436b7334bc6fce16e3cac4` | `divergent-cherry-pick` | Desktop PR #171 accepted [`2026-07-31-scient-desktop-tail.md`](upstream-reviews/2026-07-31-scient-desktop-tail.md) as repo-local checkpoint merge `83cdb7ade3585638493a099d669326a26b0fa32e`. [`2026-08-02-scient-desktop.md`](upstream-reviews/2026-08-02-scient-desktop.md) provides complete new disposition evidence through `65f6684aa6ff88c8d57a9f11d541a54b41be1539` (`ab33931d..65f6684`, 4 commits), with zero undispositioned. The bounded Codex health-probe adaptation is implemented independently at desktop commit `099c6d124e85c63b506cd1b78cb533fedc1bfbd7`. The accepted checkpoint above remains unchanged until a separate desktop state PR is reviewed and accepted. Literal integration ancestry remains unchanged. |
