...
| Scient desktop (Synara-derived) | `../scient-desktop/`; preserved primary sibling currently on local `agent/fix-file-link-worktree-resolution-20260726` at `8b8b7cc2bc87e973b9ca9919fa6285a028c19204`, not used as current-state evidence | `https://github.com/Emanuele-web04/synara.git`, `main` | `https://github.com/ScientFactory/scient-desktop`, public standalone repository | `9be46c3ce6a7521b64436b7334bc6fce16e3cac4` | Inspected owned `origin/main` `3829e5dd82a4760184aabafa4c96127744ef79f2`; the accepted repo-local checkpoint is `ab33931da4c8da884b1445244085f4eeee3eafb6`, while [`2026-08-02-scient-desktop.md`](upstream-reviews/2026-08-02-scient-desktop.md) and [`2026-08-03-scient-desktop.md`](upstream-reviews/2026-08-03-scient-desktop.md) provide complete contiguous draft evidence through `9265ca5ae006d2ccad85b67ff1d11f24ca6c3fab` with zero remaining | Accepted initial application foundation; `divergent-cherry-pick`; must not own scientific project truth. |
| T3 Code | No canonical local checkout is retained. Disposable fetch-only bare inspection repositories are used and retain no canonical authority. | `https://github.com/pingdotgg/t3code.git`, `main` | None | Not tested in Gate 1.5 | Durable targeted-review boundary remains `bf76535fe4da71d8de7b8bd5ffa0d2086b7af8d0`; [`2026-08-02-t3-code.md`](upstream-reviews/2026-08-02-t3-code.md) and [`2026-08-03-t3-code.md`](upstream-reviews/2026-08-03-t3-code.md) provide complete scheduled draft evidence through `69dfb7f09a473d270a8b127cb1c39836fa1c6bc4`; stable release remains `v0.0.31`, the latest fetched nightly `v0.0.32-nightly.20260802.980` peels to `e60821f0e0d82a5d671ca3b94719c49d333921c8`, and `main` is one commit ahead | Daily research donor for desktop/runtime/provider/process/UI lessons; not an owned upstream or integration base. |
...
|---|---|---|---|---|---|
| Scient desktop | `3829e5dd82a4760184aabafa4c96127744ef79f2` | `ab33931da4c8da884b1445244085f4eeee3eafb6` on 2026-08-01 | `9be46c3ce6a7521b64436b7334bc6fce16e3cac4` | `divergent-cherry-pick` | Desktop PR #171 accepted [`2026-07-31-scient-desktop-tail.md`](upstream-reviews/2026-07-31-scient-desktop-tail.md) as repo-local checkpoint merge `83cdb7ade3585638493a099d669326a26b0fa32e`. The 2026-08-02 and 2026-08-03 records provide complete draft dispositions through `9265ca5ae006d2ccad85b67ff1d11f24ca6c3fab` (`ab33931d..9265ca5a`, 36 commits), with zero undispositioned. The bounded Codex health-probe adaptation is commit `099c6d124e85c63b506cd1b78cb533fedc1bfbd7`; the independent Pi metadata adaptation is implemented through head `32eb90fd804d7e9feeaa06b20e97c20c70a98601`. The accepted checkpoint above remains unchanged until a separate desktop state PR is reviewed and accepted. Literal integration ancestry remains unchanged. |
