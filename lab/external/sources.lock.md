...
| T3 Code | No canonical local checkout is retained. | `https://github.com/pingdotgg/t3code.git`, `main` | None | Not tested in Gate 1.5 | Triggered review completed through `5719e8ac4020dda0e375ef61d044b61f55a0df8a`; see [`t3-code-targeted-review-2026-07-26.md`](../notes/t3-code-targeted-review-2026-07-26.md) | Trigger-driven desktop/runtime/provider/process reference only; not a continuously monitored upstream. |
...
|---|---|---|---|---|---|
| Scient desktop | `dab9b6d58e2a3f3da02c5475b86dc083f71580f1` | `0388a9b397a12771a3716587269cbd967599736a` on 2026-07-26 | `9be46c3ce6a7521b64436b7334bc6fce16e3cac4` | `divergent-cherry-pick` | [`2026-07-26-scient-desktop.md`](upstream-reviews/2026-07-26-scient-desktop.md); no source code selected or integrated; desktop checkpoint PR is a separate dependency |
