...
| Synara | `desktop-app-forks/synara/` | `https://github.com/Emanuele-web04/synara.git`, `main` | `https://github.com/yaacovcorcos/synara`, public fork | `1f81baf13b5ad9821cf32936768aa2918edb9fd3` | `a0fd3063dbc6d737d9fe6be9d2d231a65249fa3f` on `codex/gate-1-5` | Visible LitRev workbench; owned `thin-fork-merge`; must not own scientific project truth. |
