...
The lab is the controlled experimental area for turning Scient's product and
...
- Do not let upstream app state become Scient project truth.
- Do not put Scient-owned adapter code inside upstream forks unless the change is
  truly fork-specific.
