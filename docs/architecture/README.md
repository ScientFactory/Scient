...
Architecture docs explain how PapiLab should be structured and why. They must clearly distinguish proposal, accepted direction, implementation candidate, and current implementation.
