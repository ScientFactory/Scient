...
Architecture docs explain how LitRev should be structured and why. They must clearly distinguish proposal, accepted direction, implementation candidate, and current implementation.
