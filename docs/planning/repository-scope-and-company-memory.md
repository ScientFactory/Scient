...
Purpose: Recommends how the LitRev repository should relate to a broader connected company memory without mixing product authority with company-level authority.
...
This repository is the LitRev product and project knowledge workspace. It owns LitRev product direction, architecture, planning, research, design, quality, future implementation guidance, operations guidance when real, lab evidence, and project-specific agent workflows.

Commercial, market, customer, or organizational material may live here when it directly informs LitRev product work and is placed in the correct planning or research surface. This does not make the repository the unrestricted memory of the whole company.

## Options

| Model | Benefit | Main risk |
| --- | --- | --- |
| LitRev product repository only | Clearest current boundary | Company context remains disconnected unless another system links it |
...
Use a connected company-memory model. Keep this repository as the LitRev product branch of that memory, and create a separate company-level authority when company strategy, finance, legal, people, customer knowledge, or cross-product decisions need durable homes.

The logical hierarchy may be connected even when the underlying knowledge lives in more than one repository or system. Link to authoritative company material instead of duplicating it inside LitRev.
...
Before adding company-level folders or moving LitRev under a broader hierarchy, decide:
...
- how existing LitRev history would be preserved.
