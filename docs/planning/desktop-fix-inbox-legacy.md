# Legacy Desktop Fix Inbox

Status: Historical
Owner: Yaacov
Created: 2026-07-25
Last updated: 2026-08-13
Purpose: Preserves unresolved observations from the retired Synara-derived Scient desktop without presenting them as current-app work.
Doc type: Planning note

## Document Rules

This file is historical evidence from the retired Synara-derived desktop. Do
not add new entries or treat its diagnoses as current behavior. Reproduce any
still-relevant issue in the T3-derived app and record it in the current
[Desktop Fix Inbox](desktop-fix-inbox.md).
...
The original open entries remain intact so their context is not lost. They do
not establish current priority, implementation approval, or permission to
modify the retired application.
