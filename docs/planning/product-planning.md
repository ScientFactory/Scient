...
| Model access and routing | Provider-connected subscriptions, bring-your-own API keys, Scient-managed access, manual model choice, and later task-aware routing. | Core | Foundation to early expansion | None first | Connection and lifecycle candidate: [`provider-connection-and-lifecycle-experience.md`](provider-connection-and-lifecycle-experience.md). Sequencing and commercial options: `model-access-and-routing-evolution.md`. Candidate portfolio: `../research/source-evaluations/model-portfolio-and-provider-routing.md`. |
...
| Identity, organizations, sharing, collaboration, and mobile | Individual identity and affiliation; ad hoc teams; nested institutions, departments, labs, groups, and subgroups; membership in multiple groups and projects; external collaborators; project roles and permissions; invitations; presence; shared review; comments; suggestions; assignments; attribution; cloud mirror; sync and conflict states; mobile continuation. | Core | Design now; validate one narrow shared project after the first local scientific-state slice; expand in phases | Read/review/capture/approval | Keep organization roles, group membership, project membership, and scientific responsibility distinct. Architecture handoffs: collaboration model, local-first sync, security. |
...
| What relationship should Scient support among a person, affiliation, institution, department, lab, subgroup, ad hoc team, and project? | Scientific teams cross institutional boundaries, people belong to several groups, and organizational hierarchy must not silently determine project access or scientific responsibility. | Collaboration product planning, identity, and security architecture. |
| Which first shared-project workflow should precede simultaneous co-editing? | Invitations, project roles, external collaboration, comments or suggestions, attributed review, revocation, and recovery can validate the collaboration boundary before a realtime sync engine is selected. | Product roadmap, collaboration model, and local-first sync architecture. |
...
| Collaboration model | `docs/architecture/collaboration-model.md` | Individual identity and affiliation, ad hoc teams, nested institutions and research groups, external collaborators, organization-versus-project roles, membership, invitations, presence, shared review, comments, suggestions, assignments, attribution, ownership continuity, and conflict states. |
